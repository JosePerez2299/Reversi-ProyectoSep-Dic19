...
def Jugadores():
	...
	casilla_jug0_inactive=pygame.draw.rect(VENTANA,GRIS,(300,250,250,80),5)
	casilla_jug1_inactive=pygame.draw.rect(VENTANA,GRIS,(300,450,250,80),5)
	...
	while not(IntroducidoNombre0 and IntroducidoNombre1):
		...
		VENTANA.blit((fuente.render(jugadores[0],1,VERDE)),(0,0))
		
		VENTANA.blit((fuente.render(jugadores[1],1,VERDE)),(0,20))
		


		if casilla_jug0:
				casilla_jug0_active=pygame.draw.rect(VENTANA,(255,255,255),(300,250,250,80),5)
		...
		if casilla_jug1:
			casilla_jug1_active=pygame.draw.rect(VENTANA,(255,255,255),(300,450,250,80),5)
		...
		if IntroducidoNombre0:
			pygame.draw.rect(VENTANA,VERDE,(300,250,250,80),5)

		elif IntroducidoNombre1:
			pygame.draw.rect(VENTANA,VERDE,(300,450,250,80),5)
